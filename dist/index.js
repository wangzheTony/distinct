...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = new Vue({
	    ...
	    data: {
	        title: '精彩的积累',
	        footer_content: "I'm Simon, This is my Vcard. Remember me!",
	        info: '很高兴您能看到我的Vcard, 以下内容为阅读须知：',
	        active: {
	            color: '#555',
	        ...
	        works: 0,
	        contents: [
	            {id: 1, content: '本名片仅作为一个个人工作经历的纪录；'},
	            {id: 2, content: '本名片仅作为个人使用技术的集合，方便在开发过程中使用；'},
	            {id: 3, content: '本网站不做商业用处，谢谢。'},
	        ]
	    },
	    components: {
	        'app-header': __webpack_require__(3),
	        'app-footer': __webpack_require__(9)
	    }
	});
	...
	$(function(){
	    $.ajax({
	        type: "GET",
	        url: '/src/data/works.json',
	        dataType: "json",
	        data: {
	            
	        },
	        success: function(data) {
	            app.works = data.length;
	        },
	        error: function() {
	            console.log('网络错误，请联系管理员！');
	        }
	    });
	});
